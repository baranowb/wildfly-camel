...
import static org.wildfly.extension.camel.config.WildFlyCamelConfigPlugin.NS_DOMAIN_110;
...
public class StandaloneConfigTest extends ConfigTestSupport {
    ...
    public void testUnsupportedNamespaceVersion() throws Exception {
        ...
        doc.getRootElement().getChild("extensions", NS_DOMAIN_110).setNamespace(Namespace.getNamespace("urn:jboss:domain:99.99"));

...
public final class WildFlyCamelConfigPlugin implements ConfigPlugin {
    ...
    public static final Namespace NS_DOMAIN_110 = Namespace.getNamespace("urn:jboss:domain:11.0");

    public static final Namespace[] NS_DOMAINS = new Namespace[] { NS_DOMAIN_110 };
